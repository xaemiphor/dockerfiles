...
| [fooocus/entrypoint.sh](fooocus/entrypoint.sh#L50) | 50 | Fooocus is following the symlink and generating a bad URL... so this doesn't work either |
| [fooocus/entrypoint.sh](fooocus/entrypoint.sh#L63) | 63 | Check for new preset files and consider copying over |
